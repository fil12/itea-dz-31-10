<template>
  <div>
    <h1 style="color:red">/* Mixins */</h1>
    <br>
    <button @click="scrollTo($refs.bottom)" ref="top">go to bottom</button>
    <br>
    ...
    <footer ref="bottom" style="color:darkblue;font-size:25px;cursor:pointer" @click="scrollTo($refs.top)">this is bottom</footer>
  </div>
...
<script>
  ...
  export default {
    name: "Mixins",
    /* mixins - примиси. Использование повторяющегося кода */
    mixins: [scrollTo]
  }
</script>
